...
SYNTHESIS_SYSTEM_PROMPT = (
    ...
    "Do not invent sources or facts not present in the findings. If "
    "sources disagree, present both views honestly instead of picking one. "
    "If the findings are insufficient to answer part of the question, say "
